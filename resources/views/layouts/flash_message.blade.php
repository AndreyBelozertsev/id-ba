...
<div class="container">
    <div class="relative">
        <div x-data="{ expanded: true }" x-show="expanded" x-collapse.duration.1000ms 
        class="max-w-xs bg-green-500 text-sm text-white rounded-md shadow-lg m-2 absolute right-0" role="alert">
            <div class="flex p-4">
                <p class="px-4">{{ Session::pull('success_message') }}</p>
                <div class="ml-auto">
...
<div class="container">
    <div class="relative">
        <div x-data="{ expanded: true }" x-show="expanded" x-collapse.duration.1000ms 
        class="max-w-xs bg-red-500 text-sm text-white rounded-md shadow-lg m-2 absolute right-0" role="alert">
            <div class="flex p-4">
